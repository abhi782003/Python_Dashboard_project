...
class Student:
    def __init__(self,root):
        ...
        #image 1
        img=Image.open(r"D:\BE\Face_Recognition_System\images\students1.jpg")
        ...
        #image2
        img1=Image.open(r"D:\BE\Face_Recognition_System\images\students2.jpg")
        ...
        #image3
        img2=Image.open(r"D:\BE\Face_Recognition_System\images\students3.jpg")
        ...
        # backgrounf image
        img3=Image.open(r"D:\BE\Face_Recognition_System\images\bigimggg.jpg")
        ...
        imgimg_left=Image.open(r"D:\BE\Face_Recognition_System\images\students4.jpg")
        ...
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text=" CurrentCourse Information",font=("times new roman",13,"bold"))
        ...
        radionbtn2=ttk.Radiobutton(class_student_frame,variable=self.var_radio1,text=" no take photo sample",value="No")
        ...
        imgimg_right=Image.open(r"D:\BE\Face_Recognition_System\images\students5.jpg")
        imgimg_right=imgimg_right.resize((720,130),Image.ANTIALIAS)
        self.photoimg_righ=ImageTk.PhotoImage(imgimg_right)

        f_lbl=Label(Right_frame,image=self.photoimg_righ)
        f_lbl.place(x=5,y=0,width=720,height=130)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="abhi2003",database="face_recognizer")
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                delete=messagebox.askyesno("Student Delete Page","Do you want to deletethis student",parent=self.root)
                if delete>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="abhi2003",database="face_recognizer")
                    my_cursor=conn.cursor()
